...
class Program
{
    static void Main()
    {
        ...
        Assert(contactos[0].Nombre, "Juan", "Primer contacto");
        Assert(contactos[1].Nombre, "Pedro", "Segundo contacto");
        Assert(contactos[2].Nombre, "Ana", "Tercer contacto");
        ...
        Assert(contactos[0].Nombre, "Juan", "Primer contacto tras agregar Otro");
        Assert(contactos[1].Nombre, "Otro", "Segundo contacto tras agregar Otro");
        Assert(contactos[2].Nombre, "Pedro", "Tercer contacto tras agregar Otro");
        Assert(contactos[3].Nombre, "Ana", "Cuarto contacto tras agregar Otro");

        contactos.Eliminar(otro);
        Assert(contactos.Cantidad, 3, "Cantidad de contactos tras eliminar Otro");
        Assert(contactos[0].Nombre, "Juan", "Primer contacto tras eliminar Otro");
        Assert(contactos[1].Nombre, "Pedro", "Segundo contacto tras eliminar Otro");
        Assert(contactos[2].Nombre, "Ana", "Tercer contacto tras eliminar Otro");
